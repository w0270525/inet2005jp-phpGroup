...
INSERT INTO cms.PAGES (p_id, p_name, p_alias, p_desc, p_style, p_createdby)
...
USER_ROLESINSERT INTO cms.ARTICLE (a_id, a_contentarea, a_name, a_title, a_content, a_assocpage, a_createdby)
